...
async function initializeDatabase(dbPathArg) {
  ...
  const rolePermissions = [
    ...
    ['role', 'moderator', 'topic', null, 'read', 1],
    ['role', 'moderator', 'topic', null, 'create', 1],
    ['role', 'moderator', 'topic', null, 'update', 1],
    ['role', 'moderator', 'topic', null, 'delete', 1],

    ['role', 'moderator', 'comment', null, 'read', 1],
    ['role', 'moderator', 'comment', null, 'create', 1],
    ['role', 'moderator', 'comment', null, 'update', 1],
    ['role', 'moderator', 'comment', null, 'delete', 1],

    ['role', 'moderator', 'board', null, 'read', 1],
    ['role', 'moderator', 'board', null, 'create', 1],
    ['role', 'moderator', 'board', null, 'update', 1],
    ['role', 'moderator', 'board', null, 'delete', 1],

    // Admin role
    ['role', 'admin', 'forum', null, 'read', 1],
    ['role', 'admin', 'forum', null, 'create', 1],
    ['role', 'admin', 'forum', null, 'update', 1],
    ['role', 'admin', 'forum', null, 'delete', 1],

    ['role', 'admin', 'board', null, 'read', 1],
    ['role', 'admin', 'board', null, 'create', 1],
    ['role', 'admin', 'board', null, 'update', 1],
    ['role', 'admin', 'board', null, 'delete', 1],

    ['role', 'admin', 'topic', null, 'read', 1],
    ['role', 'admin', 'topic', null, 'create', 1],
    ['role', 'admin', 'topic', null, 'update', 1],
    ['role', 'admin', 'topic', null, 'delete', 1],

    ['role', 'admin', 'comment', null, 'read', 1],
    ['role', 'admin', 'comment', null, 'create', 1],
    ['role', 'admin', 'comment', null, 'update', 1],
    ['role', 'admin', 'comment', null, 'delete', 1],
